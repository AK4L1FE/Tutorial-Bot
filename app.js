...
client.on('guildMemberAdd', (member, message, guild, name, server) => {
  ...
  let adminsrole = member.hasPermission("ADMINISTRATOR");
  if (!welcomechannel) return member.adminsrole.sendMessage(`${member.guild.name} doesn't have a welcome channel, please add one`);
